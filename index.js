...
`;
    ...
    for (let i = 0; i < langs.length; i++) {
      ...
      listItem.innerHTML = `${lang}  <svg aria-hidden="true" role="status" class="inline w-4 h-4 ms-1 mb-1 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
